...
export function AnalysisSessionsPage(_context: PageRenderContext): string {
  return renderPageShell({
    ...
    description: "Browse and review saved Analysis V1 sessions for the current athlete.",
      ...
      <div class="bg-skating-card border border-slate-700 rounded-2xl p-5 shadow-xl">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p class="mt-2 text-sm text-slate-400">Each session links Biomechanics, Pace, Equipment, and Report pages under the same /analysis route.</p>
          </div>
